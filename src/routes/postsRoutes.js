 ...
 import { listarPosts, postarNovoPost, uploadImagem, atualizarNovoPost} from "../controller/postControllers.js";
 ...
 const storage = multer.diskStorage({
   ...
   filename: function (req, file, cb) {
     ...
     cb(null, file.originalname); // Considere usar uma estratégia de geração de nomes únicos para p
   }
 });
